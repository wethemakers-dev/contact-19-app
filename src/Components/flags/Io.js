...
function SvgIo(props) {
  return (
    <Svg viewBox="0 0 640 480" {...props}>
      <Defs>
        <ClipPath id="io_svg__a">
          <Path fillOpacity={0.7} d="M0 0h682.7v512H0z" />
        </ClipPath>
      </Defs>
      <G clipPath="url(#io_svg__a)" transform="scale(.9375)">
        <Path fill="#fff" fillRule="evenodd" d="M0 0h1024v512H0z" />
        <Path
          fill="#000063"
          fillRule="evenodd"
        ...
        />
        <Path fill="#000063" fillRule="evenodd" d="M0 0h261.3v158H0z" />
        <G strokeWidth="1pt">
          <Path
            fill="#fff"
