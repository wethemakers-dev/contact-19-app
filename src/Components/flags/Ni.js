    ...
    <Svg viewBox="0 0 640 480" {...props}>
      ...
      <G clipPath="url(#ni_svg__c)" transform="matrix(.8 0 0 .8 -80 0)">
        ...
        <G fill="url(#ni_svg__h)">
          ...
          <G id="ni_svg__o" fill="url(#ni_svg__i)">
            <Path
              id="ni_svg__l"
              fill="url(#ni_svg__j)"
        ...
        <G fill="#ccd11e">
          ...
          <Use width="100%" height="100%" x={-15.3} xlinkHref="#ni_svg__t" />
          <G fill="#c6cb24">
            <Path
              fill="url(#ni_svg__u)"
        ...
        <G id="ni_svg__A">
          ...
          />
          <Use width="100%" height="100%" y={-1.3} xlinkHref="#ni_svg__z" />
          <Use width="100%" height="100%" y={-2.6} xlinkHref="#ni_svg__z" />
        </G>
        <Use width="100%" height="100%" y={-3.9} xlinkHref="#ni_svg__A" />
        <Use width="100%" height="100%" y={-7.7} xlinkHref="#ni_svg__A" />
        <Path
          fill="#97c924"
