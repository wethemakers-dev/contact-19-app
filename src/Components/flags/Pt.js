      ...
      <G transform="translate(0 26.7) scale(1.06667)">
        ...
        <G id="pt_svg__e">
          <G id="pt_svg__d" fill="#ff0" stroke="#000" strokeWidth={0.5}>
            ...
            <Path id="pt_svg__a" d="M191 141.6v3.4h-4v-3.4h4z" />
            <Use width="100%" height="100%" x={10.6} xlinkHref="#pt_svg__a" />
            <Path
              id="pt_svg__b"
              d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.3a.6.6 0 01-.6-.6v-2z"
            />
            <Use width="100%" height="100%" x={10.6} xlinkHref="#pt_svg__b" />
            <Path
              fill="#000"
              stroke="none"
            ...
            />
            <Use width="100%" height="100%" x={10.6} xlinkHref="#pt_svg__c" />
          </G>
          <Use width="100%" height="100%" y={46.3} xlinkHref="#pt_svg__d" />
          <Use
            width="100%"
            height="100%"
        ...
        <Use width="100%" height="100%" x={45.7} xlinkHref="#pt_svg__d" />
        <Use
          width="100%"
          height="100%"
        ...
        <Use width="100%" height="100%" y={-26} xlinkHref="#pt_svg__f" />
        <Use width="100%" height="100%" x={-20.8} xlinkHref="#pt_svg__f" />
        <Use width="100%" height="100%" x={20.8} xlinkHref="#pt_svg__f" />
        <Use width="100%" height="100%" y={25.8} xlinkHref="#pt_svg__f" />
      </G>
    </Svg>
  );
}
